...
export class MockExamsService {
    ...
    async findAll(options: SearchMockExamDto): Promise<{ rows: MockExams[]; count: number }> {
        try {
    ...
    async update(id: string, updateDto: UpdateMockExamDto): Promise<MockExams | null> {
        try {
    ...
    async createComment(createCommentDto: CreateMockExamCommentDto, userId: string): Promise<MockExamComment> {
        try {
            const comment = await this.mockExamCommentModel.create({ ...createCommentDto, userId }, { isNewRecord: true, userId });
            return comment;
        } catch (error) {
            throw new BadRequestException({
    ...
    async findCommentByMockExam(mockExamId: string): Promise<MockExamComment[]> {
        try {
            const comments = await this.mockExamCommentModel.findAll({ where: { mockExamId } });
            return comments;
        } catch (error) {
            throw new BadRequestException({
    ...
    async findCommentByMockExamAndUser(mockExamId: string, userId: string): Promise<MockExamComment | null> {
        try {
            const comment = await this.mockExamCommentModel.findOne({ where: { mockExamId, userId } });
            return comment;
        } catch (error) {
            throw new BadRequestException({
    ...
    async updateComment(id: string, updateCommentDto: UpdateMockExamCommentDto): Promise<MockExamComment> {
        try {
