...
import { MockTypesResponseCountDto, MockTypesResponseDto, ResponseDto } from 'src/shared-types/response.dto';
...
export class MockTypeController {
    ...
    @ApiResponse({ status: 201, description: 'The mock type has been successfully created.', type: MockTypesResponseDto })
    @ApiResponse({ status: 500, description: 'Error creating mock type', type: ResponseDto<null> })
    async create(@Body() createDto: CreateMockTypeDto, @UserId() userId: string): Promise<MockTypesResponseDto> {
        try {
    ...
    @ApiResponse({ status: 200, description: 'List of mock types', type: MockTypesResponseCountDto})
    @ApiResponse({ status: 500, description: 'Error fetching mock types', type: ResponseDto<null> })
    async findAll(
    ...
    @ApiResponse({ status: 200, description: 'The mock type', type: MockTypesResponseDto })
    @ApiResponse({ status: 404, description: 'Mock type not found', type: ResponseDto<null> })
    @ApiResponse({ status: 500, description: 'Error fetching mock type', type: ResponseDto<null> })
    ...
    @ApiResponse({ status: 200, description: 'The mock type has been successfully updated.', type: MockTypesResponseDto })
    @ApiResponse({ status: 404, description: 'Mock type not found', type: ResponseDto<null> })
    @ApiResponse({ status: 500, description: 'Error updating mock type', type: ResponseDto<null> })
    async update(@Param('id') id: string, @Body() updateDto: UpdateMockTypeDto): Promise<MockTypesResponseDto> {
        try {
    ...
    @ApiResponse({ status: 200, description: 'The mock type has been successfully deleted.', type: ResponseDto<null> })
    @ApiResponse({ status: 404, description: 'Mock type not found', type: ResponseDto<null> })
    @ApiResponse({ status: 500, description: 'Error deleting mock type', type: ResponseDto<null> })
