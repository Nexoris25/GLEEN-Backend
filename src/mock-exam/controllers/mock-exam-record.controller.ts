...
import {
  MockExamRecordResponseCountDto,
  MockExamRecordResponseDto,
...
export class MockExamRecordController {
  ...
  @ApiResponse({
    status: 201,
    description: 'Mock exam record created successfully',
    type: MockExamRecordResponseDto,
  })
  @ApiResponse({
    status: 500,
    description: 'Error creating mock exam record',
    type: MockExamRecordResponseDto,
  })
  async create(
    @Body() createDto: CreateMockExamRecordDto,
    @UserId() userId: string,
  ): Promise<MockExamRecordResponseDto> {
    try {
  ...
  @ApiResponse({
    status: 200,
    description: 'Mock exam records retrieved successfully',
    type: MockExamRecordResponseCountDto,
  })
  @ApiResponse({
    status: 500,
    description: 'Error retrieving mock exam records',
    type: MockExamRecordResponseCountDto,
  })
  async findAll(
    @Query() searchDto: SearchMockExamRecordDto,
  ): Promise<MockExamRecordResponseCountDto> {
    try {
      const records =
        await this.mockExamRecordService.findAllWithCount(searchDto);
      return {
  ...
  @ApiResponse({
    status: 200,
    description: 'Mock exam record retrieved successfully',
    type: MockExamRecordResponseDto,
  })
  @ApiResponse({
    status: 404,
    description: 'Mock exam record not found',
    type: MockExamRecordResponseDto,
  })
  @ApiResponse({
    status: 500,
    description: 'Error retrieving mock exam record',
    type: MockExamRecordResponseDto,
  })
  ...
  @ApiResponse({
    status: 200,
    description: 'Mock exam record updated successfully',
    type: MockExamRecordResponseDto,
  })
  @ApiResponse({
    status: 500,
    description: 'Error updating mock exam record',
    type: MockExamRecordResponseDto,
  })
  async update(
    @Param('id') id: string,
    @Body() updateDto: UpdateMockExamRecordDto,
  ): Promise<MockExamRecordResponseDto> {
    try {
  ...
  @ApiResponse({
    status: 200,
    description: 'Mock exam record deleted successfully',
    type: MockExamRecordResponseDto,
  })
  @ApiResponse({
    status: 500,
    description: 'Error deleting mock exam record',
    type: MockExamRecordResponseDto,
  })
