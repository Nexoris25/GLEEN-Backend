...
import {
  ResponseDto,
  StudentsMockAnswersResponseCountDto,
  StudentsMockAnswersResponseDto,
...
export class StudentMockAnswerController {
  ...
  @ApiResponse({
    status: 201,
    description: 'The student mock answer has been successfully created.',
    type: StudentsMockAnswersResponseDto,
  })
  @ApiResponse({
    status: 500,
    description: 'Error creating student mock answer',
    type: ResponseDto<null>,
  })
  async create(
    @Body() createDto: CreateStudentMockAnswerDto,
    @UserId() userId,
  ): Promise<StudentsMockAnswersResponseDto> {
    try {
  ...
  @ApiResponse({
    status: 200,
    description: 'List of student mock answers',
    type: StudentsMockAnswersResponseCountDto,
  })
  @ApiResponse({
    status: 500,
    description: 'Error fetching student mock answers',
    type: ResponseDto<null>,
  })
  async findAll(
    @Query() query: SearchMockAnswerDto,
  ): Promise<StudentsMockAnswersResponseCountDto> {
    try {
  ...
  @ApiResponse({
    status: 200,
    description: 'Student mock answer fetched successfully',
    type: StudentsMockAnswersResponseDto,
  })
  @ApiResponse({
    status: 500,
    description: 'Error fetching student mock answer',
    type: ResponseDto<null>,
  })
  async findOne(
    @Param('id') id: string,
  ): Promise<ResponseDto<StudentsMockAnswers>> {
    try {
  ...
  @ApiResponse({
    status: 200,
    description: 'Student mock answer deleted successfully',
    type: ResponseDto<void>,
  })
  @ApiResponse({
    status: 500,
    description: 'Error deleting student mock answer',
    type: ResponseDto<null>,
  })
  ...
  @ApiResponse({
    status: 200,
    description: 'List of student mock answers by user ID',
    type: StudentsMockAnswersResponseCountDto,
  })
  @ApiResponse({
    status: 500,
    description: 'Error fetching student mock answers by user ID',
    type: ResponseDto<null>,
  })
  async findByUserId(
    ...
    try {
      const x = await this.studentsMockAnswersService.findByUserId(
        userId,
        offset,
        limit,
      );
  ...
  @ApiOperation({
    summary: 'Get all student mock answers by lesson ID and user ID',
  })
  @ApiResponse({
    status: 200,
    description: 'List of student mock answers by lesson ID and user ID',
    type: StudentsMockAnswersResponseCountDto,
  })
  @ApiResponse({
    status: 500,
    description: 'Error fetching student mock answers by lesson ID and user ID',
    type: ResponseDto<null>,
  })
  async findByLessonAndUserId(
    ...
    try {
      const x = await this.studentsMockAnswersService.findByLessonAndUserId(
        lessonId,
        userId,
      );
      return {
  ...
  @ApiOperation({
    summary: 'Get a student mock answer by question ID and user ID',
  })
  @ApiResponse({
    status: 200,
    description: 'The student mock answer',
    type: StudentsMockAnswersResponseDto,
  })
  @ApiResponse({
    status: 500,
    description: 'Error fetching student mock answer by question and user',
    type: ResponseDto<null>,
  })
  async findByQuestionAndUserId(
    @Param('mockQuestionId') mockQuestionId: string,
    @Param('userId') userId: string,
  ): Promise<ResponseDto<StudentsMockAnswers>> {
    try {
      const x = await this.studentsMockAnswersService.findByMockQuestionAndUser(
        mockQuestionId,
        userId,
      );
      return {
