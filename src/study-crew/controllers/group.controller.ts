...
import { ApiOperation, ApiResponse, ApiTags, ApiQuery, ApiBody, ApiParam, ApiConsumes, ApiBearerAuth, } from '@nestjs/swagger';
...
import { GroupResponseCountDto, GroupResponseDto, ResponseDto } from 'src/shared-types/response.dto';
...
@UseInterceptors(
  ...
  @ApiResponse({ status: 500, description: 'Error creating group', type: GroupResponseDto })
  async create(@Body() createGroupDto: CreateGroupDto, @UploadedFile() avatar: Express.Multer.File, @UserId() userId: string): Promise<GroupResponseDto> {

     try {
    // 1️⃣ Create the group
    const group = await this.groupService.create(createGroupDto, userId, avatar);
  ...
  @ApiResponse({ status: 200, description: 'Groups retrieved successfully', type: GroupResponseCountDto })
  @ApiResponse({ status: 500, description: 'Error retrieving groups', type: ResponseDto<null> })
  async findAll(@Query('search') search?: string, @Query('offset') offset?: number, @Query('limit') limit?: number): Promise<GroupResponseCountDto> {
    try {
  ...
  @ApiResponse({ status: 404, description: 'Group not found', type: ResponseDto<null> })
  @ApiResponse({ status: 500, description: 'Error retrieving group', type: ResponseDto<null> })
...
@UseInterceptors(
  ...
  @ApiResponse({ status: 500, description: 'Error updating group', type: ResponseDto<null> })
  async update(
    @Param('id') id: string,
    @Body() updateGroupDto: UpdateGroupDto, @UploadedFile() avatar: Express.Multer.File,
  ) {
    try {
      const updated = await this.groupService.update(id, updateGroupDto, avatar,);
      return {
        status: HttpStatus.OK,
  ...
  @ApiParam({ name: 'id', description: 'Group ID' })
  @ApiResponse({ status: 200, description: 'Group deleted successfully', type: ResponseDto<void> })
  @ApiResponse({ status: 500, description: 'Error deleting group', type: ResponseDto<null> })
  ...
  @ApiResponse({ status: 200, description: 'Member added to group successfully', type: ResponseDto<UserGroup> })
  @ApiResponse({ status: 500, description: 'Internal server error', type: ResponseDto<null> })
  ...
  @ApiResponse({ status: 200, description: 'Members added to group successfully', type: ResponseDto<UserGroup[]> })
  @ApiResponse({ status: 500, description: 'Internal server error', type: ResponseDto<null> })
  async addMembers(@Body() body: { userId: string; groupIds: string[] }) {
    try {
      const result = await this.groupService.linkMany(body.userId, body.groupIds);
      return {
        status: HttpStatus.OK,
  ...
  @ApiBody({ schema: { example: { userId: '1', groupId: '2' } } })
  @ApiResponse({ status: 200, description: 'Member removed from group successfully', type: ResponseDto<UserGroup> })
  @ApiResponse({ status: 500, description: 'Internal server error', type: ResponseDto<null> })
  async removeMember(@Body() body: { userId: string; groupId: string }) {
    try {
      const result = await this.groupService.unlinkOne(body.userId, body.groupId);
      return {
        status: HttpStatus.OK,
  ...
  @ApiBody({ schema: { example: { userId: '1', groupIds: ['2', '3', '4'] } } })
  @ApiResponse({ status: 200, description: 'Members removed from group successfully', type: ResponseDto<UserGroup[]> })
  @ApiResponse({ status: 500, description: 'Internal server error', type: ResponseDto<null> })
  async removeMembers(@Body() body: { userId: string; groupIds: string[] }) {
    try {
      const result = await this.groupService.unlinkMany(body.userId, body.groupIds);
      return {
        status: HttpStatus.OK,
  ...
  @ApiOperation({ summary: 'Get all groups linked to a user with status ACCEPTED' })
  @ApiResponse({ status: 200, description: 'Groups retrieved successfully', type: ResponseDto<Group[]> })
  @ApiResponse({ status: 500, description: 'Error retrieving groups', type: ResponseDto<null> })
  ...
  @ApiOperation({ summary: 'Get all groups linked to a user with status PENDING' })
  @ApiResponse({ status: 200, description: 'Groups retrieved successfully', type: ResponseDto<Group[]> })
  @ApiResponse({ status: 500, description: 'Error retrieving groups', type: ResponseDto<null> })
  ...
  @ApiOperation({ summary: 'Get all groups linked to a user with status REJECTED' })
  @ApiResponse({ status: 200, description: 'Groups retrieved successfully', type: ResponseDto<Group[]> })
  @ApiResponse({ status: 500, description: 'Error retrieving groups', type: ResponseDto<null> })
  ...
  @ApiOperation({ summary: 'Get all users linked to a group with status ACCEPTED' })
  @ApiParam({ name: 'groupId', description: 'Group ID' })
  @ApiResponse({ status: 200, description: 'Users retrieved successfully', type: ResponseDto<UserGroup[]> })
  @ApiResponse({ status: 500, description: 'Error retrieving users', type: ResponseDto<null> })
  ...
  @ApiOperation({ summary: 'Get all users linked to a group with status PENDING' })
  @ApiParam({ name: 'groupId', description: 'Group ID' })
  @ApiResponse({ status: 200, description: 'Users retrieved successfully', type: ResponseDto<UserGroup[]> })
  @ApiResponse({ status: 500, description: 'Error retrieving users', type: ResponseDto<null> })
  ...
  @ApiOperation({ summary: 'Get all users linked to a group with status REJECTED' })
  @ApiParam({ name: 'groupId', description: 'Group ID' })
  @ApiResponse({ status: 200, description: 'Users retrieved successfully', type: ResponseDto<UserGroup[]> })
  @ApiResponse({ status: 500, description: 'Error retrieving users', type: ResponseDto<null> })
  ...
  @ApiResponse({ status: 200, description: 'User group status updated successfully', type: ResponseDto<UserGroup> })
  @ApiResponse({ status: 404, description: 'UserGroup link not found', type: ResponseDto<null> })
  @ApiResponse({ status: 500, description: 'Error updating user group status', type: ResponseDto<null> })
  async updateUserGroupStatus(
    ...
    try {
      const updated = await this.groupService.updateUserGroupStatus(userId, groupId, body.status);
      return {
        status: HttpStatus.OK,
