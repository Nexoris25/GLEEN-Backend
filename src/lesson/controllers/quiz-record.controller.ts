...
export class QuizRecordController {
  ...
  @ApiResponse({
    status: 201,
    description: 'Quiz record created successfully',
    type: QuizRecordResponseDto,
  })
  @ApiResponse({
    status: 500,
    description: 'Error creating quiz record',
    type: QuizRecordResponseDto,
  })
  async create(
    @Body() createDto: CreateQuizRecordDto,
    @UserId() userId: string,
  ): Promise<QuizRecordResponseDto> {
    try {
  ...
  @ApiResponse({
    status: 200,
    description: 'Quiz records retrieved successfully',
    type: QuizRecordResponseCountDto,
  })
  @ApiResponse({
    status: 500,
    description: 'Error retrieving quiz records',
    type: QuizRecordResponseCountDto,
  })
  async findAll(
    @Query() searchDto: SearchQuizRecordDto,
  ): Promise<QuizRecordResponseCountDto> {
    try {
  ...
  @ApiResponse({
    status: 200,
    description: 'Quiz record retrieved successfully',
    type: QuizRecordResponseDto,
  })
  ...
  @ApiResponse({
    status: 200,
    description: 'Quiz record updated successfully',
    type: QuizRecordResponseDto,
  })
  @ApiResponse({ status: 500, description: 'Error updating quiz record' })
  async update(
    @Param('id') id: string,
    @Body() updateDto: UpdateQuizRecordDto,
  ): Promise<QuizRecordResponseDto> {
    try {
