...
import { LessonTopicResponseCountDto, LessonTopicResponseDto, PaginationResponseDto, ResponseDto } from 'src/shared-types/response.dto';
...
async create(
  ...
  @ApiResponse({ status: 200, description: 'Lesson topics retrieved successfully', type: LessonTopicResponseCountDto })
  @ApiResponse({ status: 500, description: 'Error retrieving lesson topics', type: ResponseDto })
  async findAll(@Query() searchDto: SearchLessonTopicDto): Promise<LessonTopicResponseCountDto> {
    try {
  ...
  @ApiResponse({ status: 200, description: 'Lesson topic retrieved successfully', type: LessonTopicResponseDto })
  @ApiResponse({ status: 404, description: 'Lesson topic not found', type: ResponseDto })
  @ApiResponse({ status: 500, description: 'Error retrieving lesson topic', type: ResponseDto })
...
async update(
  ...
  @ApiParam({ name: 'id', description: 'Lesson topic ID' })
  @ApiResponse({ status: 200, description: 'Lesson topic deleted successfully', type: LessonTopicResponseDto })
  @ApiResponse({ status: 500, description: 'Error deleting lesson topic', type: ResponseDto })
