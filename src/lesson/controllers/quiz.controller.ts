...
export class QuizController {
    ...
    async create(@Body() createDto: CreateQuizDto, @UserId() userId: string): Promise<QuizzesResponseDto> {
        try {
    ...
    async update(@Param('id') id: string, @Body() updateDto: UpdateQuizDto): Promise<QuizzesResponseDto> {
        try {
