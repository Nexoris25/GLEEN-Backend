...
export class QuizQuestionController {
  ...
  @ApiResponse({
    status: 500,
    description: 'Error creating quiz question',
    type: ResponseDto<null>,
  })
  async create(
  ...
  @ApiResponse({
    ...
    type: QuizQuestionsResponseCountDto,
  })
  @ApiResponse({
    status: 500,
  ...
  @ApiResponse({
    status: 500,
    description: 'Error fetching quiz question',
    type: ResponseDto<null>,
  })
  ...
  @ApiResponse({
    status: 500,
    description: 'Error updating quiz question',
    type: ResponseDto<null>,
  })
  async update(
    @Param('id') id: string,
  ...
  @ApiResponse({
    status: 500,
    description: 'Error deleting quiz question',
    type: ResponseDto<null>,
  })
