...
export class GoalController {
  ...
  @ApiResponse({
    status: 500,
    description: 'Error retrieving goal',
    type: ResponseDto,
  })
  ...
  @ApiResponse({
    status: 200,
    description: 'Goal linked to user successfully',
    type: GoalResponseDto,
  })
  @ApiResponse({
    status: 500,
  ...
  @ApiResponse({
    status: 200,
    description: 'Goals linked to user successfully',
    type: GoalArrayResponseDto,
  })
  @ApiResponse({
    status: 500,
  ...
  @ApiResponse({
    status: 200,
    description: 'Goal unlinked from user successfully',
    type: GoalResponseDto,
  })
  @ApiResponse({
    status: 500,
  ...
  @ApiResponse({
    status: 200,
    description: 'Goals unlinked from user successfully',
    type: GoalArrayResponseDto,
  })
  @ApiResponse({
    status: 500,
  ...
  async unlinkMany(@Body() body: { userId: string; goalIds: string[] }) {
    try {
      const result = await this.goalService.unlinkMany(
        body.userId,
        body.goalIds,
      );
      return {
