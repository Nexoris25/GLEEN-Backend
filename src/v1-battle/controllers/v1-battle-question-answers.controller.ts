...
import {
  ResponseDto,
  V1BattleQuestionAnswersResponseCountDto,
  V1BattleQuestionAnswersResponseDto,
...
export class V1BattleQuestionAnswersController {
  ...
  @ApiResponse({
    status: 201,
    description: 'Battle question answer created successfully',
    type: V1BattleQuestionAnswersResponseDto,
  })
  @ApiResponse({
    status: 500,
    description: 'Error creating battle question answer',
    type: ResponseDto<null>,
  })
  async create(
    @Body() createDto: CreateV1BattleQuestionAnswersDto,
    @UserId() userId: string,
  ): Promise<V1BattleQuestionAnswersResponseDto> {
    try {
      ...
      const answer = await this.v1BattleQuestionAnswersService.create(
        createDto,
        userId,
      );
      return {
  ...
  @Get()
  @ApiOperation({
    summary: 'Get all battle question answers (optionally by search)',
  })
  ...
  @ApiResponse({
    status: 200,
    description: 'Battle question answers retrieved successfully',
    type: V1BattleQuestionAnswersResponseCountDto,
  })
  @ApiResponse({
    status: 500,
    description: 'Error retrieving battle question answers',
    type: ResponseDto<null>,
  })
  async findAll(
    @Query() searchDto: SearchV1BattleQuestionAnswersDto,
  ): Promise<V1BattleQuestionAnswersResponseCountDto> {
    try {
      const answers =
        await this.v1BattleQuestionAnswersService.findAll(searchDto);
      return {
  ...
  @ApiResponse({
    status: 200,
    description: 'Battle question answer retrieved successfully',
    type: V1BattleQuestionAnswersResponseDto,
  })
  @ApiResponse({
    status: 404,
    description: 'Battle question answer not found',
    type: ResponseDto<null>,
  })
  @ApiResponse({
    status: 500,
    description: 'Error retrieving battle question answer',
    type: ResponseDto<null>,
  })
  async findOne(
    @Param('id') id: string,
  ...
  @ApiResponse({
    status: 200,
    description: 'Battle question answer updated successfully',
    type: V1BattleQuestionAnswersResponseDto,
  })
  @ApiResponse({
    status: 500,
    description: 'Error updating battle question answer',
    type: ResponseDto<null>,
  })
  async update(
    @Param('id') id: string,
    @Body() updateDto: UpdateV1BattleQuestionAnswersDto,
  ): Promise<V1BattleQuestionAnswersResponseDto> {
    try {
      const answer = await this.v1BattleQuestionAnswersService.update(
        id,
        updateDto,
      );
      return {
  ...
  @ApiResponse({
    status: 200,
    description: 'Battle question answer deleted successfully',
    type: ResponseDto<null>,
  })
  @ApiResponse({
    status: 500,
    description: 'Error deleting battle question answer',
    type: ResponseDto<null>,
  })
