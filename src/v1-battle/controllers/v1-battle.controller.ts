...
export class V1BattleController {
  constructor(
    private readonly v1BattleService: V1BattleService,
  ...
  @ApiResponse({
    ...
    type: V1BattleResponseDto,
  })
  @ApiResponse({
    status: 500,
    description: 'Error creating battle',
    type: ResponseDto,
  })
  async create(
    @Body() createDto: CreateV1BattleDto,
    @UserId() userId: string,
  ): Promise<V1BattleResponseDto> {
    try {
...
*/
  ...
  @ApiResponse({
    ...
    type: V1BattleResponseCountDto,
  })
  @ApiResponse({
    status: 500,
    description: 'Error retrieving battles',
    type: ResponseDto,
  })
  async findAll(
    @Query() searchDto: SearchV1BattleDto,
  ): Promise<V1BattleResponseCountDto> {
    try {
  ...
  @ApiResponse({
    status: 500,
    description: 'Error retrieving battle',
    type: ResponseDto,
  })
  ...
  @ApiResponse({
    status: 500,
    description: 'Error updating battle',
    type: ResponseDto,
  })
  async update(
    @Param('id') id: string,
    @Body() updateDto: UpdateV1BattleDto,
  ): Promise<V1BattleResponseDto> {
    try {
  ...
  @ApiResponse({
    status: 500,
    description: 'Error deleting battle',
    type: ResponseDto,
  })
