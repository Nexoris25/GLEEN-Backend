...
import { BeforeCreate, BelongsTo, Column, DataType, ForeignKey, Model, Table, Unique } from 'sequelize-typescript';
...
export class V1BattleQuestionAnswers extends Model {
    ...
    @BeforeCreate
    static async setUserId(instance: V1BattleQuestionAnswers, options: { [key: string]: any }) {
