    ...
    async initializeDefaultConfiguration(): Promise<XpConfiguration> {
        try {
            ...
            const defaultConfig: CreateXpConfigurationDto = {
                ...
                // xpValueForLessThanOrEqualTo10MockJambQuestion: 30,
                // xpValueForGreaterThan10LessThanOrEqualTo20MockJambQuestion: 60,
                // xpValueForGreaterThan20LessThanOrEqualTo30MockJambQuestion: 90,
