...
export class ComplaintCommentController {
    ...
    async create(@Body() dto: CreateComplaintCommentDto, @UserId() userId: string): Promise<ComplaintCommentResponseDto> {
        try {
    ...
    @ApiQuery({ name: 'complaintId', required: false, description: 'Filter by complaint ID' })
    @ApiQuery({ name: 'userId', required: false, description: 'Filter by user ID' })
    @ApiQuery({ name: 'search', required: false, description: 'Search comment text' })
    ...
    @ApiResponse({ status: 200, description: 'Filtered comments', type: ComplaintCommentArrayResponseDto })
    ...
    @ApiResponse({ status: 200, description: 'Comment updated successfully', type: ComplaintCommentResponseDto })
    async update(@Param('id') id: string, @Body() dto: UpdateComplaintCommentDto) {
        try {
    ...
    @ApiParam({ name: 'id', type: String })
    @ApiResponse({ status: 200, description: 'Comment deleted successfully', type: ComplaintCommentResponseDto })
