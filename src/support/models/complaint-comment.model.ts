...
import { BeforeCreate, BelongsTo, Column, DataType, Default, IsUUID, Model, PrimaryKey, Table } from 'sequelize-typescript';
...
export class ComplaintComment extends Model<ComplaintComment> {
    ...
    @BeforeCreate
    static async setUserId(instance: ComplaintComment, options: { [key: string]: any }) {
